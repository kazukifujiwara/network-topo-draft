...
さらに [MCP Apps](https://modelcontextprotocol.io/extensions/apps/overview) 対応
ホストでは、`render_svg` の結果が会話の中に**インタラクティブなインライン
キャンバス**(パン/ズーム・物理⇄論理切替)として描画されます — 非対応ホストには
従来どおりの SVG が返ります。
